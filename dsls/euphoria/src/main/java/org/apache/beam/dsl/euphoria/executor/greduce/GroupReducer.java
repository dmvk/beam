 ...
 */
package org.apache.beam.dsl.euphoria.executor.greduce;

import org.apache.beam.dsl.euphoria.client.accumulators.AccumulatorProvider;
import org.apache.beam.dsl.euphoria.client.accumulators.Counter;
import org.apache.beam.dsl.euphoria.client.accumulators.Histogram;
import org.apache.beam.dsl.euphoria.client.accumulators.Timer;
import org.apache.beam.dsl.euphoria.client.dataset.windowing.MergingWindowing;
import org.apache.beam.dsl.euphoria.client.dataset.windowing.TimedWindow;
import org.apache.beam.dsl.euphoria.client.dataset.windowing.Window;
import org.apache.beam.dsl.euphoria.client.dataset.windowing.WindowedElement;
import org.apache.beam.dsl.euphoria.client.dataset.windowing.Windowing;
import org.apache.beam.dsl.euphoria.client.functional.BinaryFunction;
import org.apache.beam.dsl.euphoria.client.io.Context;
import org.apache.beam.dsl.euphoria.client.operator.state.ListStorage;
import org.apache.beam.dsl.euphoria.client.operator.state.ListStorageDescriptor;
import org.apache.beam.dsl.euphoria.client.operator.state.MergingStorageDescriptor;
import org.apache.beam.dsl.euphoria.client.operator.state.State;
import org.apache.beam.dsl.euphoria.client.operator.state.StateFactory;
import org.apache.beam.dsl.euphoria.client.operator.state.StateMerger;
import org.apache.beam.dsl.euphoria.client.operator.state.Storage;
import org.apache.beam.dsl.euphoria.client.operator.state.StorageDescriptor;
import org.apache.beam.dsl.euphoria.client.operator.state.StorageProvider;
import org.apache.beam.dsl.euphoria.client.operator.state.ValueStorage;
import org.apache.beam.dsl.euphoria.client.operator.state.ValueStorageDescriptor;
import org.apache.beam.dsl.euphoria.client.triggers.Trigger;
import org.apache.beam.dsl.euphoria.client.triggers.TriggerContext;
import org.apache.beam.dsl.euphoria.client.util.Pair;
...
public class GroupReducer<WID extends Window, KEY, I> {
  ...
  class ElementCollector<T> implements Context, org.apache.beam.dsl.euphoria.client.io.Collector<T> {
