 ...
 */
package org.apache.beam.dsl.euphoria.executor;

import org.apache.beam.dsl.euphoria.client.dataset.Dataset;
import org.apache.beam.dsl.euphoria.client.dataset.windowing.Time;
import org.apache.beam.dsl.euphoria.client.flow.Flow;
import org.apache.beam.dsl.euphoria.client.graph.DAG;
import org.apache.beam.dsl.euphoria.client.graph.Node;
import org.apache.beam.dsl.euphoria.client.io.Collector;
import org.apache.beam.dsl.euphoria.client.io.ListDataSink;
import org.apache.beam.dsl.euphoria.client.io.MockStreamDataSource;
import org.apache.beam.dsl.euphoria.client.io.StdoutSink;
import org.apache.beam.dsl.euphoria.client.operator.FlatMap;
import org.apache.beam.dsl.euphoria.client.operator.Join;
import org.apache.beam.dsl.euphoria.client.operator.MapElements;
import org.apache.beam.dsl.euphoria.client.operator.Operator;
import org.apache.beam.dsl.euphoria.client.operator.ReduceByKey;
import org.apache.beam.dsl.euphoria.client.operator.ReduceStateByKey;
...
public class FlowUnfolderTest {
  ...
  public void testUnfoldBasic() {
    ...
    assertEquals(FlowUnfolder.InputOperator.class, root.get().getClass());
